...
SELECT CASE
       ...
       END AS bonus_statuses,
       COUNT(id) AS donor_count,
       ROUND(AVG(confirmed_donations),2) AS avg_amount_donor
FROM donor_activity
GROUP BY bonus_statuses;
-- Таблица:
-- bonus_statuses     | donor_count        | avg_amount_donor 
-- -------------------|--------------------|----------------------------
